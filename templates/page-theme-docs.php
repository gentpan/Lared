                ...
                <div class="theme-docs-content mx-auto max-w-[1150px] px-0 py-10 max-[900px]:px-5 max-[900px]:py-8">
                    ...
                    <div class="theme-docs-feature-group mt-12">
                        ...
                        <p class="mt-3 text-sm text-[#999]">
                            <?php echo esc_html($theme_name); ?> <?php esc_html_e('由', 'lared'); ?> <a href="<?php echo esc_url($author_url); ?>" target="_blank" rel="noopener" class="text-[var(--color-accent)] hover:underline"><?php echo esc_html($theme_author); ?></a> <?php esc_html_e('独立设计开发。', 'lared'); ?>
                        </p>
                    </div>
