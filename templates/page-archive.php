...
foreach ($archive_posts as $archive_post) {
    ...
    $archive_total_words += function_exists('lared_get_word_count')
        ? lared_get_word_count($post_id)
        : 0;
...
<main class="main-shell year-month-archive-page mx-auto w-full max-w-[1400px] min-h-[calc(100vh-64px)] border-x border-[#d9d9d9] bg-[#ffffff] pb-[90px] max-[900px]:pb-16">
        ...
        <div class="listing-head-inner">
            ...
            <div class="listing-head-main">
                <div class="listing-head-title-row archive-head-title-row">
                    <h1 class="listing-head-title"><i class="fa-sharp fa-thin fa-books" aria-hidden="true"></i><?php echo esc_html(wp_specialchars_decode(get_the_title(), ENT_QUOTES)); ?></h1>
                    ...
                    <div class="archive-head-stats" aria-label="归档统计">
                        ...
                        <span class="archive-head-stat">
                            <b><?php echo esc_html(number_format_i18n($archive_total_words)); ?></b>
