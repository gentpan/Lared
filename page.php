...
if (have_posts()) :
    while (have_posts()) :
        ...
        <main class="main-shell mx-auto w-full max-w-[1400px] min-h-[calc(100vh-64px)] border-x border-[#d9d9d9] bg-[#ffffff] pb-[90px] max-[900px]:pb-16">
                ...
                <div class="listing-head-inner">
                    ...
                    <div class="listing-head-main">
                        <div class="listing-head-title-row">
                            <h1 class="listing-head-title"><i class="<?php echo $is_xalbum_page ? 'fa-sharp fa-thin fa-image' : 'fa-sharp fa-thin fa-bookmark'; ?>" aria-hidden="true"></i><?php echo esc_html(wp_specialchars_decode(get_the_title(), ENT_QUOTES)); ?></h1>
            ...
            <section class="listing-content<?php echo $is_xalbum_page ? ' listing-content--album' : ''; ?>">
